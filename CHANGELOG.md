...
- **Performance:** Fixed a critical bug that caused a ~5-second activation delay. All I/O-bound startup logic, including watcher initialization and state checking, is now fully decoupled from the activation process, ensuring the extension loads instantly.
